...
func newRecorderUploadPanel(win fyne.Window) *recorderUploadPanel {
	...
	p.uploadingList = widget.NewList(
		...
		func(id widget.ListItemID, obj fyne.CanvasObject) {
			...
			updateBackingBarItem(obj, e.label(), summary, prog, nil, false, false, false, p.win, "", syncengine.RoleAudio)
		},
	)
	p.uploadedList = widget.NewList(
		...
		func(id widget.ListItemID, obj fyne.CanvasObject) {
			...
			updateBackingBarItem(obj, e.label(), summary, 1.0, e.err, e.err != nil, false, false, p.win, "", syncengine.RoleAudio)
		},
	)
	return p
}
