...
// granularity, always Location <-> Location. It never exposes sub-experiment
...
func showSyncExperiments(s *state) {
	...
	if loc := findLocation(s.cfg.Locations, s.syncExperimentsDstName); loc != nil {
		dstLoc = loc
